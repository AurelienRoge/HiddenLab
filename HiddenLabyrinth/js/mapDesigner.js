...
function initializeDesignerMapGraph() {
    ...
    designerGraph[1] = new designerTile(tileSizeInPxDesigner, tileSizeInPxDesigner, imagesTab[44], tileSizeInPxDesigner, 0);
    designerGraph[tailleDesigner] = new designerTile(tileSizeInPxDesigner, tileSizeInPxDesigner, imagesTab[44], 0, tileSizeInPxDesigner);
    designerGraph[tailleDesigner + 1] = new designerTile(tileSizeInPxDesigner, tileSizeInPxDesigner, imagesTab[44], tileSizeInPxDesigner, tileSizeInPxDesigner);
    //End
...
function initializeDesignerMapTab() {
    ...
    mapTabDesigner[0] = "A";
    mapTabDesigner[1] = "Z";
    mapTabDesigner[tailleDesigner] = "E";
    mapTabDesigner[tailleDesigner + 1] = "R";
    ...
    mapTabDesigner[mapTabDesigner.length - 1] = "T";
    mapTabDesigner[mapTabDesigner.length - 2] = "T";
    mapTabDesigner[mapTabDesigner.length - tailleDesigner - 1] = "T";
    mapTabDesigner[mapTabDesigner.length - tailleDesigner - 2] = "T";
}
